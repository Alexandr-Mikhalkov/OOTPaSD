...
{
    public class Trapezoid : CommonArr
    {
        private int _lengthX = 0;
        private int _lengthY = 0;

        public Trapezoid(Color penColor, Color brushColor, int penWidth, Point startPoint)
            : base(penColor, penWidth, startPoint)
        {
            ...
            points = new List<Point>
            {
                ...
                new Point(startPoint.X + _lengthX * 3 / 4, startPoint.Y - _lengthY),
                new Point(startPoint.X + _lengthX / 4, startPoint.Y - _lengthY)
            };
        }
        ...
        public override void UpdateState(Point currentPos)
        {
            ...
            points[2] = new Point(points[0].X + _lengthX * 3 / 4, points[0].Y - _lengthY);
            points[3] = new Point(points[0].X + _lengthX / 4, points[0].Y - _lengthY);
        }
